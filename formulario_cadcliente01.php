<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        //print_r('<br>');
        //print_r('Data de Nascimento: ' .$_POST['data_nascometo']);
        //print_r('<br>');
        ...
        $sexo = $_POST['genero'];
        $data_nasc = $_POST['data_nascometo'];
        $cidade = $_POST['cidade'];
        $estado = $_POST['estado'];
        $endereco = $_POST['endereco'];

        $result = mysqli_query($conexao, "INSERT INTO usuarios(nome,emal,telefone, sexo, data_nasc, cidade, endereco)VALUES ('$nome','$email','$telefone','$sexo', '$data_nasc', '$cidade' , '$estado','$endereco')");
